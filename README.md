...
## 수업에 대한 내용
1. 이번 수업에서 기대한 것:  
   게임 개발의 기초부터 고급 기술까지 다루며, 독립적으로 프로젝트를 완성할 수 있는 능력을 기를 수 있기를 기대했습니다.
   
2. 이번 수업에서 얻은 것:
   프레임워크 활용 능력: gfw.py 프레임워크를 활용해 게임 씬을 관리하고, 객체 지향 설계와 모듈화를 통해 효율적으로 개발하는 방법을 배웠습니다.  
   게임 기획 및 개발 경험: 단순히 코드를 작성하는 것을 넘어, 게임의 컨셉을 기획하고 이를 구현하는 과정을 경험할 수 있었습니다. 플레이어 경험을 고려한 기능 설계와 디테일한 조정의 중요성을 깨달았습니다.
   
3. 이번 수업에서 얻지 못한 것:  
   실행 파일 제작 관련 문제 해결: PyInstaller로 실행 파일을 제작했지만, 다른 컴퓨터에서 실행되지 않는 문제를 해결하지 못해 아쉬움이 남습니다.   
